...
// Thu Nov  2 10:53:41 2017 by ROOT version 6.10/00
// from TTree ntp1/myNtuple
// found on file: /net/g20/ph/1/jsn150130/LambdaC-Run1-OffPeak-R24c-v07-1.root
//////////////////////////////////////////////////////////

#ifndef LambdaCSelector_h
#define LambdaCSelector_h
...
class LambdaCSelector : public TSelector {
public :
   ...
   LambdaCSelector(TTree * /*tree*/ =0) { }
   virtual ~LambdaCSelector() { }
   ...
   ClassDef(LambdaCSelector,0);

};

#endif

#ifdef LambdaCSelector_cxx
void LambdaCSelector::Init(TTree *tree)
{
...
#endif // #ifdef LambdaCSelector_cxx
